          ...
          >
            <div className="fixed inset-0 bg-black bg-opacity-10 backdrop-blur-sm flex  items-center  place-content-center ">
              <div className="bg-slate-300 md:h-[40%] h-[30%] md:w-[25%] w-[65%] rounded-md">
               ...
               <article>1. User Data Collection and Usage
...
By using our platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you have any questions or concerns, please contact us at [contact email/phone number].</article>
                  <a
