    ...
    useEffect(() => {
        if (formData.birthday) {
            setFormData({
                ...formData,
                age: Math.floor(
                    (new Date() - new Date(formData.birthday)) / 3.15576e10
                ),
            })
        }
    }, [formData.birthday]);
                    ...
                    <div className="flex gap-3">
                        <Dialog.Root open={openMigrate} onOpenChange={setOpenMigrate}>
                            ...
                            <Dialog.Portal>
                                ...
                                <Dialog.Content
                                    className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[1000px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                        ...
                                        <div className="flex gap-5">
                                                ...
                                                {location.pathname === "/admin/list-visitors" ? (
                                                    <>
                                                        <fieldset className="mb-[15px] flex items-center gap-5">
                                                            <label
                                                                className="text-violet11 w-[175px] text-right text-[15px]">
                                                                Name of Visitor
                                                            </label>
                                                            <input
                                                        ...
                                                        <fieldset className="mb-[15px] flex items-start gap-5">
                                                            <label
                                                                className="text-violet11 w-[175px] text-right text-[15px] pt-1">
                                                                Date Visited
                                                            </label>
                                                            <div className="flex-grow">
                                                                <input
                                            ...
                                            <div className="shrink-0 text-center">
                                                {image ? (
                                                    ...
                                                    <div
                                                        className="rounded-lg font-bold text-6xl bg-gray-200 aspect-video flex items-center justify-center w-[300px]">
                                                        +
                                                    </div>
                                                )}
                        ...
                        >
                            ...
                            <Dialog.Portal>
                                <Dialog.Overlay
                                    className="bg-blackA6 data-[state=open]:animate-overlayShow fixed inset-0"/>
                                <Dialog.Content
                                    className="overflow-auto data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[1000px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                                    <Dialog.Title className="text-mauve12 m-0 text-[17px] font-medium">
                                        Notifications
                                    </Dialog.Title>
